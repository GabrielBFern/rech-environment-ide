  ...
  provideAutocomplete() {
    return {
      ...
      getSuggestions: ({editor, bufferPosition, scopeDescriptor, prefix}) => {
        var promises = [
          this.loadVariablesPreproc(editor, bufferPosition, scopeDescriptor, prefix),
          this.loadParagraphsPreproc(editor, bufferPosition, scopeDescriptor, prefix)
        ];
      ...
      if (tmpPath.exists()) {
        tmpPath.loadBuffer().then((buffer) => {
            ...
            for (var i in lines) {
              ...
              if (autocomplete.displayText != undefined && autocomplete.displayText.toLowerCase().startsWith(prefix.toLowerCase())) {
